...
/**
 * BQPricingTermsInitiateOutputModel
 */
public class BQPricingTermsInitiateOutputModel   {
  private String pricingTermsInstanceReference = null;

  private String pricingTermsInitiateActionReference = null;

  private Object pricingTermsInitiateActionRecord = null;

  private String pricingTermsInstanceStatus = null;
  ...
  **/
   ...
   * @return pricingTermsInitiateActionReference
  **/

  public String getPricingTermsInitiateActionReference() {
    return pricingTermsInitiateActionReference;
  }

  public void setPricingTermsInitiateActionReference(String pricingTermsInitiateActionReference) {
    this.pricingTermsInitiateActionReference = pricingTermsInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Pricing Terms instance (e.g. initialised, pending, active) 
   * @return pricingTermsInstanceStatus
  **/

  public String getPricingTermsInstanceStatus() {
    return pricingTermsInstanceStatus;
  }

  public void setPricingTermsInstanceStatus(String pricingTermsInstanceStatus) {
    this.pricingTermsInstanceStatus = pricingTermsInstanceStatus;
  }
